...
TEST(NeuralNetwork, XorLocalSearchTraining) {
	...
	nn.train_local_search(dataset, 20000, 1.0, 4, 5, "training_results/xor_local_search", 1);
...
TEST(NeuralNetwork, XorSimulatedAnnealingTraining) {
	...
	nn.train_simulated_annealing(dataset, 2000, 1.0, 4, 0.95F, 30.0F, 0.0F, "training_results/xor_simulated_annealing", 1);
