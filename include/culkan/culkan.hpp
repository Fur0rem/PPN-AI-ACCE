...
/**
 * @file include/culkan/culkan.h
 * @brief Culkan API to use to do computations on the GPU
 */
 ...
 * @param nb_x the number of workgroups in the x direction
 * @param nb_y the number of workgroups in the y direction
 * @param nb_z the number of workgroups in the z direction
 */
void culkanSetup(Culkan* culkan, int nb_x, int nb_y, int nb_z);
