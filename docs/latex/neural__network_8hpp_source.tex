...
\DoxyCodeLine{00040\ \ \ \ \ \mbox{\hyperlink{classTrainingNoise}{TrainingNoise}}(\textcolor{keywordtype}{float}\ dropout\_rate,\ \textcolor{keywordtype}{float}\ add\_noise,\ \textcolor{keywordtype}{float}\ mult\_noise,\ \textcolor{keywordtype}{float}\ regularisation\_term);}
\DoxyCodeLine{00041\ }
...
\DoxyCodeLine{00090\ \ \ \ \ \mbox{\hyperlink{classNeuralNetwork}{NeuralNetwork}}(\textcolor{keyword}{const}\ std::vector<size\_t>\&\ topology,\ std::unique\_ptr<ActivationFunc>\ activation\_func,}
...
\DoxyCodeLine{00166\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ batch\_size,\ \mbox{\hyperlink{classIOptimiser}{IOptimiser}}\&\ optimiser,\ \textcolor{keywordtype}{float}\ train\_acc\_threshold\_at\_half,}
...
\DoxyCodeLine{00211\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classIOptimiser}{IOptimiser}}\&\ optimiser,\ \textcolor{keywordtype}{size\_t}\ nb\_epochs\_gradient,}
...
\DoxyCodeLine{00330\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ std::chrono::duration<double>\ total\_time,\ \mbox{\hyperlink{classIOptimiser}{IOptimiser}}\&\ optimiser);}
\DoxyCodeLine{00331\ \};}
\DoxyCodeLine{00332\ }
