...
\item 
\mbox{\hyperlink{classNeuralNetwork_ac12a81e6cb73e864e63eab78e9d3df8b}{Neural\+Network}} (const std\+::vector$<$ size\+\_\+t $>$ \&topology, std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classActivationFunc}{Activation\+Func}} $>$ activation\+\_\+func, std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classTrainingNoise}{Training\+Noise}} $>$ training\+\_\+noise)
...
std\+::pair$<$ float, float $>$ \mbox{\hyperlink{classNeuralNetwork_ab1952a76041cb0e50d6535a6682df66c}{train\+\_\+batch\+\_\+for\+\_\+topology\+\_\+finder}} (\mbox{\hyperlink{classDataset}{Dataset}} \&dataset, size\+\_\+t nb\+\_\+epochs, float training\+\_\+proportion, size\+\_\+t batch\+\_\+size, \mbox{\hyperlink{classIOptimiser}{IOptimiser}} \&optimiser, float train\+\_\+acc\+\_\+threshold\+\_\+at\+\_\+half, float validation\+\_\+acc\+\_\+threshold\+\_\+at\+\_\+half)
\begin{DoxyCompactList}\small\item\em Train the neural network using the given dataset with batch training and return the accuracy of training and validation data. Used in the topology finder. \end{DoxyCompactList}\item 
std\+::pair$<$ float, float $>$ \mbox{\hyperlink{classNeuralNetwork_a02bd65c5db701c3301788e2bb9dc5027}{train\+\_\+local\+\_\+search}} (\mbox{\hyperlink{classDataset}{Dataset}} \&dataset, size\+\_\+t nb\+\_\+epochs, float training\+\_\+proportion, size\+\_\+t nb\+\_\+samples, std\+::string \&\&logging\+\_\+dir, size\+\_\+t nb\+\_\+trains)
\begin{DoxyCompactList}\small\item\em Trains the neural network through local search. \end{DoxyCompactList}\item 
std\+::pair$<$ float, float $>$ \mbox{\hyperlink{classNeuralNetwork_aa1b39b03fa993f0d62b5fce966d977b0}{train\+\_\+simulated\+\_\+annealing}} (\mbox{\hyperlink{classDataset}{Dataset}} \&dataset, size\+\_\+t nb\+\_\+epochs, float training\+\_\+proportion, float decay\+\_\+rate, size\+\_\+t nb\+\_\+tracked, float initial\+\_\+temp, std\+::string \&\&logging\+\_\+dir, size\+\_\+t nb\+\_\+trains)
\begin{DoxyCompactList}\small\item\em Trains the network through simulated annealing. \end{DoxyCompactList}\item 
std\+::pair$<$ float, float $>$ \mbox{\hyperlink{classNeuralNetwork_a70644d4bdfd0812f44e7d1c989ae170a}{train\+\_\+simulated\+\_\+annealing\+\_\+and\+\_\+gradient}} (\mbox{\hyperlink{classDataset}{Dataset}} \&dataset, size\+\_\+t nb\+\_\+epochs, float training\+\_\+proportion, float decay\+\_\+rate, size\+\_\+t nb\+\_\+tracked, float initial\+\_\+temp, \mbox{\hyperlink{classIOptimiser}{IOptimiser}} \&optimiser, size\+\_\+t nb\+\_\+epochs\+\_\+gradient, size\+\_\+t batch\+\_\+size\+\_\+gradient, std\+::string \&\&logging\+\_\+dir, size\+\_\+t nb\+\_\+trains)
\begin{DoxyCompactList}\small\item\em Trains the network through simulated annealing and gradient descent within the annealing candidates. \end{DoxyCompactList}\item 
...
\Hypertarget{classNeuralNetwork_ac12a81e6cb73e864e63eab78e9d3df8b}\index{NeuralNetwork@{NeuralNetwork}!NeuralNetwork@{NeuralNetwork}}
\index{NeuralNetwork@{NeuralNetwork}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{NeuralNetwork()}{NeuralNetwork()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_ac12a81e6cb73e864e63eab78e9d3df8b} 
Neural\+Network\+::\+Neural\+Network (\begin{DoxyParamCaption}\item[{const std\+::vector$<$ size\+\_\+t $>$ \&}]{topology}{, }\item[{std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classActivationFunc}{Activation\+Func}} $>$}]{activation\+\_\+func}{, }\item[{std\+::unique\+\_\+ptr$<$ \mbox{\hyperlink{classTrainingNoise}{Training\+Noise}} $>$}]{training\+\_\+noise}{}\end{DoxyParamCaption})}
...
\hline
{\em training\+\_\+noise} & Training noise for the neural network \\
\hline
\end{DoxyParams}


\doxysubsection{Member Function Documentation}
\Hypertarget{classNeuralNetwork_ac8c1cba779e5c2eba780aa8b4ed46ad9}\index{NeuralNetwork@{NeuralNetwork}!absolute\_error@{absolute\_error}}
...
{\footnotesize\ttfamily \label{classNeuralNetwork_ac8c1cba779e5c2eba780aa8b4ed46ad9} 
double Neural\+Network\+::absolute\+\_\+error (\begin{DoxyParamCaption}\item[{std\+::vector$<$ float $>$ \&}]{prediction}{, }\item[{std\+::vector$<$ float $>$ \&}]{target}{, }\item[{const \mbox{\hyperlink{classIEncoder}{IEncoder}} \texorpdfstring{$\ast$}{*}}]{encoder}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_abc20c216225113fe5ed400c8a61d4134}\index{NeuralNetwork@{NeuralNetwork}!backward@{backward}}
\index{backward@{backward}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{backward()}{backward()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_abc20c216225113fe5ed400c8a61d4134} 
\mbox{\hyperlink{classGradients}{Gradients}} Neural\+Network\+::backward (\begin{DoxyParamCaption}\item[{const Eigen\+::\+Matrix\+Xf \&}]{inputs}{, }\item[{const Eigen\+::\+Matrix\+Xf \&}]{targets}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a6d0c02bd3d2f3056f717847f3a8e36c7}\index{NeuralNetwork@{NeuralNetwork}!feed\_forward@{feed\_forward}}
\index{feed\_forward@{feed\_forward}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{feed\_forward()}{feed\_forward()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_a6d0c02bd3d2f3056f717847f3a8e36c7} 
Eigen\+::\+Matrix\+Xf Neural\+Network\+::feed\+\_\+forward (\begin{DoxyParamCaption}\item[{const Eigen\+::\+Matrix\+Xf \&}]{input}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_aea39f4830c1e2061f7142a099ef4646c}\index{NeuralNetwork@{NeuralNetwork}!get\_acc\_mae@{get\_acc\_mae}}
\index{get\_acc\_mae@{get\_acc\_mae}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{get\_acc\_mae()}{get\_acc\_mae()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_aea39f4830c1e2061f7142a099ef4646c} 
double Neural\+Network\+::get\+\_\+acc\+\_\+mae (\begin{DoxyParamCaption}\item[{const Eigen\+::\+Matrix\+Xf \&}]{inputs}{, }\item[{const Eigen\+::\+Matrix\+Xf \&}]{targets}{, }\item[{const \mbox{\hyperlink{classIEncoder}{IEncoder}} \texorpdfstring{$\ast$}{*}}]{encoder}{}\end{DoxyParamCaption})}
...
The mean absolute error 
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a9a15238ea0ce3cb14687588f6db3ffc3}\index{NeuralNetwork@{NeuralNetwork}!get\_acc\_mrae@{get\_acc\_mrae}}
...
{\footnotesize\ttfamily \label{classNeuralNetwork_a9a15238ea0ce3cb14687588f6db3ffc3} 
double Neural\+Network\+::get\+\_\+acc\+\_\+mrae (\begin{DoxyParamCaption}\item[{const Eigen\+::\+Matrix\+Xf \&}]{inputs}{, }\item[{const Eigen\+::\+Matrix\+Xf \&}]{targets}{, }\item[{const \mbox{\hyperlink{classIEncoder}{IEncoder}} \texorpdfstring{$\ast$}{*}}]{encoder}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a13371d9e2af79bf76d4c8400ced49750}\index{NeuralNetwork@{NeuralNetwork}!get\_loss\_mrse@{get\_loss\_mrse}}
...
{\footnotesize\ttfamily \label{classNeuralNetwork_a13371d9e2af79bf76d4c8400ced49750} 
double Neural\+Network\+::get\+\_\+loss\+\_\+mrse (\begin{DoxyParamCaption}\item[{const Eigen\+::\+Matrix\+Xf \&}]{inputs}{, }\item[{const Eigen\+::\+Matrix\+Xf \&}]{targets}{, }\item[{const \mbox{\hyperlink{classIEncoder}{IEncoder}} \texorpdfstring{$\ast$}{*}}]{encoder}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a22bce90f6f04becff364a118608af773}\index{NeuralNetwork@{NeuralNetwork}!get\_loss\_mse@{get\_loss\_mse}}
...
{\footnotesize\ttfamily \label{classNeuralNetwork_a22bce90f6f04becff364a118608af773} 
double Neural\+Network\+::get\+\_\+loss\+\_\+mse (\begin{DoxyParamCaption}\item[{const Eigen\+::\+Matrix\+Xf \&}]{inputs}{, }\item[{const Eigen\+::\+Matrix\+Xf \&}]{targets}{, }\item[{const \mbox{\hyperlink{classIEncoder}{IEncoder}} \texorpdfstring{$\ast$}{*}}]{encoder}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a1d6854f374769491c08c2e426c6d28f7}\index{NeuralNetwork@{NeuralNetwork}!log\_epoch\_metrics@{log\_epoch\_metrics}}
...
\hline
\end{DoxyParams}
\Hypertarget{classNeuralNetwork_a2ab8cdad24b0705cb49c2392a23997bc}\index{NeuralNetwork@{NeuralNetwork}!log\_final\_results@{log\_final\_results}}
...
\hline
\end{DoxyParams}
\Hypertarget{classNeuralNetwork_a33c50d558598b59a33674c12dff24d75}\index{NeuralNetwork@{NeuralNetwork}!predict@{predict}}
...
{\footnotesize\ttfamily \label{classNeuralNetwork_a33c50d558598b59a33674c12dff24d75} 
Eigen\+::\+Matrix\+Xf Neural\+Network\+::predict (\begin{DoxyParamCaption}\item[{const Eigen\+::\+Matrix\+Xf \&}]{input}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_ad4ba2cdffa852f86885e1f18cbeeb4e4}\index{NeuralNetwork@{NeuralNetwork}!predict@{predict}}
\index{predict@{predict}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{predict()}{predict()}\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily \label{classNeuralNetwork_ad4ba2cdffa852f86885e1f18cbeeb4e4} 
std\+::vector$<$ float $>$ Neural\+Network\+::predict (\begin{DoxyParamCaption}\item[{const std\+::vector$<$ float $>$ \&}]{input}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a1c920457c478addf1a5c2ad981cf8f28}\index{NeuralNetwork@{NeuralNetwork}!relative\_absolute\_error@{relative\_absolute\_error}}
...
{\footnotesize\ttfamily \label{classNeuralNetwork_a1c920457c478addf1a5c2ad981cf8f28} 
double Neural\+Network\+::relative\+\_\+absolute\+\_\+error (\begin{DoxyParamCaption}\item[{std\+::vector$<$ float $>$ \&}]{prediction}{, }\item[{std\+::vector$<$ float $>$ \&}]{target}{, }\item[{const \mbox{\hyperlink{classIEncoder}{IEncoder}} \texorpdfstring{$\ast$}{*}}]{encoder}{}\end{DoxyParamCaption})}
...
The mean relative absolute error 
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a146ca44ada660e0619bfc462e2fcced2}\index{NeuralNetwork@{NeuralNetwork}!relative\_squared\_error@{relative\_squared\_error}}
...
{\footnotesize\ttfamily \label{classNeuralNetwork_a146ca44ada660e0619bfc462e2fcced2} 
double Neural\+Network\+::relative\+\_\+squared\+\_\+error (\begin{DoxyParamCaption}\item[{std\+::vector$<$ float $>$ \&}]{prediction}{, }\item[{std\+::vector$<$ float $>$ \&}]{target}{, }\item[{const \mbox{\hyperlink{classIEncoder}{IEncoder}} \texorpdfstring{$\ast$}{*}}]{encoder}{}\end{DoxyParamCaption})}
...
The mean relative squared error 
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a3e41ea08d6d8d80ba178322d1e0f1091}\index{NeuralNetwork@{NeuralNetwork}!reset@{reset}}
\index{reset@{reset}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{reset()}{reset()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_a3e41ea08d6d8d80ba178322d1e0f1091} 
void Neural\+Network\+::reset (\begin{DoxyParamCaption}{}{}\end{DoxyParamCaption})}



Reset the neural network to its initial state. 

This function resets the weights and biases of the neural network to their initial values. \Hypertarget{classNeuralNetwork_a3fb5ece18f9e2cd67c540b1cfcb3da49}\index{NeuralNetwork@{NeuralNetwork}!squared\_error@{squared\_error}}
...
{\footnotesize\ttfamily \label{classNeuralNetwork_a3fb5ece18f9e2cd67c540b1cfcb3da49} 
double Neural\+Network\+::squared\+\_\+error (\begin{DoxyParamCaption}\item[{std\+::vector$<$ float $>$ \&}]{prediction}{, }\item[{std\+::vector$<$ float $>$ \&}]{target}{, }\item[{const \mbox{\hyperlink{classIEncoder}{IEncoder}} \texorpdfstring{$\ast$}{*}}]{encoder}{}\end{DoxyParamCaption})}
...
The mean relative squared error 
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_aab78d40f586338dad53b7c29255dfdcd}\index{NeuralNetwork@{NeuralNetwork}!train@{train}}
\index{train@{train}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{train()}{train()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_aab78d40f586338dad53b7c29255dfdcd} 
std\+::pair$<$ float, float $>$ Neural\+Network\+::train (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classDataset}{Dataset}} \&}]{dataset}{, }\item[{size\+\_\+t}]{nb\+\_\+epochs}{, }\item[{float}]{training\+\_\+proportion}{, }\item[{float}]{learning\+\_\+rate}{, }\item[{std\+::string \&\&}]{logging\+\_\+dir}{, }\item[{size\+\_\+t}]{nb\+\_\+trains}{}\end{DoxyParamCaption})}
...
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a769264b6424463724390ef9a0b18741c}\index{NeuralNetwork@{NeuralNetwork}!train\_batch@{train\_batch}}
\index{train\_batch@{train\_batch}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{train\_batch()}{train\_batch()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_a769264b6424463724390ef9a0b18741c} 
...
A pair of floats containing the training and validation accuracy 
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_ab1952a76041cb0e50d6535a6682df66c}\index{NeuralNetwork@{NeuralNetwork}!train\_batch\_for\_topology\_finder@{train\_batch\_for\_topology\_finder}}
\index{train\_batch\_for\_topology\_finder@{train\_batch\_for\_topology\_finder}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{train\_batch\_for\_topology\_finder()}{train\_batch\_for\_topology\_finder()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_ab1952a76041cb0e50d6535a6682df66c} 
std\+::pair$<$ float, float $>$ Neural\+Network\+::train\+\_\+batch\+\_\+for\+\_\+topology\+\_\+finder (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classDataset}{Dataset}} \&}]{dataset}{, }\item[{size\+\_\+t}]{nb\+\_\+epochs}{, }\item[{float}]{training\+\_\+proportion}{, }\item[{size\+\_\+t}]{batch\+\_\+size}{, }\item[{\mbox{\hyperlink{classIOptimiser}{IOptimiser}} \&}]{optimiser}{, }\item[{float}]{train\+\_\+acc\+\_\+threshold\+\_\+at\+\_\+half}{, }\item[{float}]{validation\+\_\+acc\+\_\+threshold\+\_\+at\+\_\+half}{}\end{DoxyParamCaption})}



Train the neural network using the given dataset with batch training and return the accuracy of training and validation data. Used in the topology finder. 
...
{\em optimiser} & Optimiser to use for training \\
\hline
{\em train\+\_\+acc\+\_\+threshold\+\_\+at\+\_\+half} & If the training accuracy is below this value at half the training, stop the training (early stopping) \\
\hline
{\em validation\+\_\+acc\+\_\+threshold\+\_\+at\+\_\+half} & If the validation accuracy is below this value at half the training, stop the training (early stopping) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
A pair of floats containing the training and validation accuracy 
\end{DoxyReturn}
\Hypertarget{classNeuralNetwork_a02bd65c5db701c3301788e2bb9dc5027}\index{NeuralNetwork@{NeuralNetwork}!train\_local\_search@{train\_local\_search}}
\index{train\_local\_search@{train\_local\_search}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{train\_local\_search()}{train\_local\_search()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_a02bd65c5db701c3301788e2bb9dc5027} 
std\+::pair$<$ float, float $>$ Neural\+Network\+::train\+\_\+local\+\_\+search (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classDataset}{Dataset}} \&}]{dataset}{, }\item[{size\+\_\+t}]{nb\+\_\+epochs}{, }\item[{float}]{training\+\_\+proportion}{, }\item[{size\+\_\+t}]{nb\+\_\+samples}{, }\item[{std\+::string \&\&}]{logging\+\_\+dir}{, }\item[{size\+\_\+t}]{nb\+\_\+trains}{}\end{DoxyParamCaption})}



Trains the neural network through local search. 
...
{\em training\+\_\+proportion} & Proportion of data to use for training (The rest will be used for validation) \\
\hline
{\em nb\+\_\+samples} & Number of samples to look for when stepping \\
\hline
{\em logging\+\_\+dir} & Directory to log results \\
\hline
{\em nb\+\_\+trains} & Number of training runs \\
\hline
\end{DoxyParams}
\Hypertarget{classNeuralNetwork_aa1b39b03fa993f0d62b5fce966d977b0}\index{NeuralNetwork@{NeuralNetwork}!train\_simulated\_annealing@{train\_simulated\_annealing}}
\index{train\_simulated\_annealing@{train\_simulated\_annealing}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{train\_simulated\_annealing()}{train\_simulated\_annealing()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_aa1b39b03fa993f0d62b5fce966d977b0} 
std\+::pair$<$ float, float $>$ Neural\+Network\+::train\+\_\+simulated\+\_\+annealing (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classDataset}{Dataset}} \&}]{dataset}{, }\item[{size\+\_\+t}]{nb\+\_\+epochs}{, }\item[{float}]{training\+\_\+proportion}{, }\item[{float}]{decay\+\_\+rate}{, }\item[{size\+\_\+t}]{nb\+\_\+tracked}{, }\item[{float}]{initial\+\_\+temp}{, }\item[{std\+::string \&\&}]{logging\+\_\+dir}{, }\item[{size\+\_\+t}]{nb\+\_\+trains}{}\end{DoxyParamCaption})}



Trains the network through simulated annealing. 
...
{\em training\+\_\+proportion} & Proportion of data to use for training (The rest will be used for validation) \\
\hline
{\em decay\+\_\+rate} & Decay rate for the temperature \\
\hline
{\em nb\+\_\+tracked} & Number of tracked weights and biases through the training \\
\hline
{\em initial\+\_\+temp} & Initial temperature for the annealing \\
\hline
{\em logging\+\_\+dir} & Directory to log results \\
\hline
{\em nb\+\_\+trains} & Number of training runs \\
\hline
\end{DoxyParams}
\Hypertarget{classNeuralNetwork_a70644d4bdfd0812f44e7d1c989ae170a}\index{NeuralNetwork@{NeuralNetwork}!train\_simulated\_annealing\_and\_gradient@{train\_simulated\_annealing\_and\_gradient}}
\index{train\_simulated\_annealing\_and\_gradient@{train\_simulated\_annealing\_and\_gradient}!NeuralNetwork@{NeuralNetwork}}
\doxysubsubsection{\texorpdfstring{train\_simulated\_annealing\_and\_gradient()}{train\_simulated\_annealing\_and\_gradient()}}
{\footnotesize\ttfamily \label{classNeuralNetwork_a70644d4bdfd0812f44e7d1c989ae170a} 
std\+::pair$<$ float, float $>$ Neural\+Network\+::train\+\_\+simulated\+\_\+annealing\+\_\+and\+\_\+gradient (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classDataset}{Dataset}} \&}]{dataset}{, }\item[{size\+\_\+t}]{nb\+\_\+epochs}{, }\item[{float}]{training\+\_\+proportion}{, }\item[{float}]{decay\+\_\+rate}{, }\item[{size\+\_\+t}]{nb\+\_\+tracked}{, }\item[{float}]{initial\+\_\+temp}{, }\item[{\mbox{\hyperlink{classIOptimiser}{IOptimiser}} \&}]{optimiser}{, }\item[{size\+\_\+t}]{nb\+\_\+epochs\+\_\+gradient}{, }\item[{size\+\_\+t}]{batch\+\_\+size\+\_\+gradient}{, }\item[{std\+::string \&\&}]{logging\+\_\+dir}{, }\item[{size\+\_\+t}]{nb\+\_\+trains}{}\end{DoxyParamCaption})}



Trains the network through simulated annealing and gradient descent within the annealing candidates. 
...
{\em optimiser} & Optimiser to use for training \\
\hline
{\em nb\+\_\+epochs\+\_\+gradient} & Number of epochs to train for the gradient descent \\
\hline
{\em batch\+\_\+size\+\_\+gradient} & Size of the batch for training \\
\hline
{\em logging\+\_\+dir} & Directory to log results \\
\hline
{\em nb\+\_\+trains} & Number of training runs \\
