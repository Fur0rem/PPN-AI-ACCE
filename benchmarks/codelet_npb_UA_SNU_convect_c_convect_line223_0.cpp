/**
 * @file benchmarks/codelet_polybench_convect_c_convect_line223_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) convect_c_convect_line223_0 codelet
 */
...
BENCHMARK_FN(convect_c_convect_line223_loop_c_0_c, {
	int __k_0__ = k;
	int __j_1__ = j;
	int __i_2__ = i;
...
/**
 * @brief Run the benchmarks for convect_c_convect_line223_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(convect_c_convect_line223_loop_c_0_c).results();
