/**
 * @file benchmarks/codelet_polybench_sp_c_pinvr_line1235_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) sp_c_pinvr_line1235_0 codelet
 */
...
BENCHMARK_FN(sp_c_pinvr_line1235_loop_c_0_c, {
		...
		for (__i_3__ = 1; __i_3__ <= __arr_sub_0__ - 2; __i_3__ += 1) {
			for (__j_4__ = 1; __j_4__ <= __arr_sub_1__ - 2; __j_4__ += 1) {
				for (__k_5__ = 1; __k_5__ <= __arr_sub_2__ - 2; __k_5__ += 1) {
					...
					t1 = bt * r1;
					t2 = 0.5 * (r4 + r5);
					rhs[0][__i_3__][__j_4__][__k_5__] = bt * (r4 - r5);
					rhs[1][__i_3__][__j_4__][__k_5__] = -r3;
					rhs[2][__i_3__][__j_4__][__k_5__] = r2;
...
/**
 * @brief Run the benchmarks for sp_c_pinvr_line1235_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(sp_c_pinvr_line1235_loop_c_0_c).results();
