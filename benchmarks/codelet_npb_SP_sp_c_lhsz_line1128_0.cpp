/**
 * @file benchmarks/codelet_polybench_sp_c_lhsz_line1128_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) sp_c_lhsz_line1128_0 codelet
 */
...
BENCHMARK_FN(sp_c_lhsz_line1128_loop_c_0_c, {
...

	{
		for (__i_3__ = 1; __i_3__ <= __arr_sub_0__ - 2; __i_3__ += 1) {
			for (__j_4__ = 1; __j_4__ <= __arr_sub_1__ - 2; __j_4__ += 1) {
				for (__k_5__ = 3; __k_5__ <= __arr_sub_2__ - 4; __k_5__ += 1) {
...
/**
 * @brief Run the benchmarks for sp_c_lhsz_line1128_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(sp_c_lhsz_line1128_loop_c_0_c).results();
