/**
 * @file benchmarks/codelet_polybench_sp_c_z_solve_line2901_120.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) sp_c_z_solve_line2901_120 codelet
 */
...
BENCHMARK_FN(sp_c_z_solve_line2901_loop_c_120_c, {
...
/**
 * @brief Run the benchmarks for sp_c_z_solve_line2901_loop_c_120_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(sp_c_z_solve_line2901_loop_c_120_c).results();
