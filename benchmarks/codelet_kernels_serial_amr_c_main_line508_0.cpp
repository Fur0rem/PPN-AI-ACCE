/**
 * @file benchmarks/codelet_serial_amr_c_main_line508_0.cpp
...
BENCHMARK_FN(amr_c_main_line508_loop_c_0_c, {
	int __j_0__ = j;
	int __i_1__ = i;
...
/**
 * @brief Run the benchmarks for amr_c_main_line508_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(amr_c_main_line508_loop_c_0_c).results();
