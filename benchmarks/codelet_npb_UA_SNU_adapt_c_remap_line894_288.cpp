/**
 * @file benchmarks/codelet_polybench_adapt_c_remap_line894_288.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) adapt_c_remap_line894_288 codelet
 */
...
BENCHMARK_FN(adapt_c_remap_line894_loop_c_288_c, {
	int __iz_0__ = iz;
	int __kk_1__ = kk;
	int __jj_2__ = jj;
	int __ii_3__ = ii;
...
/**
 * @brief Run the benchmarks for adapt_c_remap_line894_loop_c_288_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(adapt_c_remap_line894_loop_c_288_c).results();
