/**
 * @file benchmarks/codelet_polybench_sp_c_y_solve_line2675_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) sp_c_y_solve_line2675_0 codelet
 */
...
OPTIMISE_SIZE
BENCHMARK_FN(sp_c_y_solve_line2675_loop_c_0_c, {
...
/**
 * @brief Run the benchmarks for sp_c_y_solve_line2675_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(sp_c_y_solve_line2675_loop_c_0_c).results();
