/**
 * @file benchmarks/codelet_polybench_bt_c_compute_rhs_line2122_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) bt_c_compute_rhs_line2122_0 codelet
 */
...
BENCHMARK_FN(bt_c_compute_rhs_line2122_loop_c_0_c, {
			...
			for (__j_3__ = 1; __j_3__ <= __arr_sub_1__ - 1 - 1; __j_3__ += 1) {
				...
				for (__m_4__ = 0; __m_4__ <= 4; __m_4__ += 1) {
					rhs[__i_2__][__j_3__][k][__m_4__] =
						rhs[__i_2__][__j_3__][k][__m_4__] -
						dssp * (-4.0 * u[__i_2__][__j_3__][k - 1][__m_4__] + 6.0 * u[__i_2__][__j_3__][k][__m_4__] -
...
/**
 * @brief Run the benchmarks for bt_c_compute_rhs_line2122_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(bt_c_compute_rhs_line2122_loop_c_0_c).results();
