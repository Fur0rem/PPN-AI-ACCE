/**
 * @file benchmarks/codelet_polybench_sp_c_exact_rhs_line301_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) sp_c_exact_rhs_line301_0 codelet
 */
...
BENCHMARK_FN(sp_c_exact_rhs_line301_loop_c_0_c, {
...
/**
 * @brief Run the benchmarks for sp_c_exact_rhs_line301_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(sp_c_exact_rhs_line301_loop_c_0_c).results();
