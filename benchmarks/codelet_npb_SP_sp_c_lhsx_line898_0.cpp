/**
 * @file benchmarks/codelet_polybench_sp_c_lhsx_line898_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) sp_c_lhsx_line898_0 codelet
 */
...
BENCHMARK_FN(sp_c_lhsx_line898_loop_c_0_c, {
	...
	{
		for (__i_3__ = 3; __i_3__ <= __arr_sub_0__ - 4; __i_3__ += 1) {
...
/**
 * @brief Run the benchmarks for sp_c_lhsx_line898_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(sp_c_lhsx_line898_loop_c_0_c).results();
