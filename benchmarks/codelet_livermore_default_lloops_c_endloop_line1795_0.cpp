/**
 * @file benchmarks/codelet_livermore_default_lloops_c_endloop_line1795_0.cpp
...
BENCHMARK_FN(lloops_c_endloop_line1795_loop_c_0_c, {
	int __k_0__ = k;
	int __i_1__ = i;
...
int main() {
	...
	auto result = BENCHMARK_INIT(10, oss).RUN(lloops_c_endloop_line1795_loop_c_0_c).results();
