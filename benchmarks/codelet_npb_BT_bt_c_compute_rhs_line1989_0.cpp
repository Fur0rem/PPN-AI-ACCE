/**
 * @file benchmarks/codelet_polybench_bt_c_compute_rhs_line1989_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) bt_c_compute_rhs_line1989_0 codelet
 */
...
BENCHMARK_FN(bt_c_compute_rhs_line1989_loop_c_0_c, {
...
/**
 * @brief Run the benchmarks for bt_c_compute_rhs_line1989_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(bt_c_compute_rhs_line1989_loop_c_0_c).results();
