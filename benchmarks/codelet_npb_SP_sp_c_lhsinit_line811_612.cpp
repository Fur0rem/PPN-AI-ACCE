/**
 * @file benchmarks/codelet_polybench_sp_c_lhsinit_line811_612.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) sp_c_lhsinit_line811_612 codelet
 */
...
BENCHMARK_FN(sp_c_lhsinit_line811_loop_c_612_c, {
...
/**
 * @brief Run the benchmarks for sp_c_lhsinit_line811_loop_c_612_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(sp_c_lhsinit_line811_loop_c_612_c).results();
