/**
 * @file benchmarks/codelet_polybench_diffuse_c_diffusion_line63_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) diffuse_c_diffusion_line63_0 codelet
 */
...
BENCHMARK_FN(diffuse_c_diffusion_line63_loop_c_0_c, {
	int __ie_0__ = ie;
	int __k_1__ = k;
	int __j_2__ = j;
	int __i_3__ = i;
...
/**
 * @brief Run the benchmarks for diffuse_c_diffusion_line63_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(diffuse_c_diffusion_line63_loop_c_0_c).results();
