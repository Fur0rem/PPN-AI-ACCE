/**
 * @file benchmarks/codelet_polybench_sp_c_lhsz_line1159_0.cpp
 * @brief Benchmark extracted from the NAS Parallel Benchmarks (NPB) sp_c_lhsz_line1159_0 codelet
 */
...
double dttz2 = 0.047250;
double speed[64 / 2 * 2 + 1][64 / 2 * 2 + 1][64 / 2 * 2 + 1];

OPTIMISE_SIZE
BENCHMARK_FN(sp_c_lhsz_line1159_loop_c_0_c, {
			...
			for (__j_4__ = 1; __j_4__ <= __arr_sub_1__ - 2; __j_4__ += 1) {
				for (__k_5__ = 1; __k_5__ <= __arr_sub_2__ - 2; __k_5__ += 1) {
					...
					lhs[1 + 5][__i_3__][__j_4__][__k_5__] =
						lhs[1][__i_3__][__j_4__][__k_5__] - dttz2 * speed[__i_3__][__j_4__][__k_5__ - 1];
					lhs[2 + 5][__i_3__][__j_4__][__k_5__] = lhs[2][__i_3__][__j_4__][__k_5__];
					lhs[3 + 5][__i_3__][__j_4__][__k_5__] =
						lhs[3][__i_3__][__j_4__][__k_5__] + dttz2 * speed[__i_3__][__j_4__][__k_5__ + 1];
...
/**
 * @brief Run the benchmarks for sp_c_lhsz_line1159_loop_c_0_c
 */
int main() {
	std::ostringstream oss;
	auto result = BENCHMARK_INIT(10, oss).RUN(sp_c_lhsz_line1159_loop_c_0_c).results();
